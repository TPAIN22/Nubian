  ...
  return (
    ...
    <Stack.Screen
     options={{ headerShown: true,
      ...
      headerTitleStyle: { fontSize: 24, fontWeight: "semibold", color: "#A37E2C" },
      headerRight: () => (<Image source={require("../assets/images/icon.png")} style={{ width: 60, height: 60 }} />)  }}/>
      <ScrollView style={{ backgroundColor: "#fff" , paddingTop: headerHeight }}>
        {/* صورة المنتج */}
        <View style={{ borderRadius: 10, overflow: "hidden" ,marginTop: 20 ,alignItems: "center" ,paddingHorizontal: 20}}>
          <Image
            source={product.image || require("../assets/images/human.jpeg")}
            style={{ width: width -20, height: 250 , borderRadius: 20 }}
            contentFit="cover"
          />
        </View>
        {/* تفاصيل المنتج */}
        <View style={{ gap: 30 }}>
          {/* اسم المنتج */}
          <Text
            style={{ fontSize: 34, fontWeight: "bold", textAlign: "right" , paddingHorizontal: 20 , }}
          >
            {product.name}
          </Text>
