/**
 * Shared design tokens — one spacing/radius/typography source of truth for the
 * whole app (checkout, auth, profile, …) so screens share the same rhythm and
 * never disagree on a magic number.
 */
